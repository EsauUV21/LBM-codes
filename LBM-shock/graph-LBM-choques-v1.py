...
grafico1 = axs[0].imshow(u, cmap='plasma', animated = True, origin='lower', vmin = 0.0, vmax = 6000.0)
...
grafico2 = axs[1].imshow(rho, cmap='viridis', animated = True, origin='lower', vmin = 0.0, vmax = 5.0)
